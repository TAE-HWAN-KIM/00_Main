...
window.onload = () => {
    ...
    // const buttonsCon = document.querySelector('.buttonsCon');
    // buttonsCon.addEventListener('click', buttonClickEvent);

    // let activeFdata = '';

    // function buttonClickEvent(e) {              
    //     activeFdata = e.target.getAttribute('data-fdata')
